...
//  @PostMapping("/create-item-stuff")
//   public String itemsStuff(HttpSession session, @ModelAttribute("createStuff") ItemsStuff stuff) {
//         try {
//             Connection connection = dataSource.getConnection();
//             String sql = "INSERT INTO item_stuff(name, quantity, date, allocation, warranty) VALUES (?,?,?,?,?)";
//             final var statement = connection.prepareStatement(sql);

//             statement.setString(1, stuff.getName());
//             statement.setInt(2, stuff.getQuantity());
//             statement.setDate(3, stuff.getDate());
//             statement.setString(4, stuff.getAllocation());
//             statement.setString(5, stuff.getWarranty());
//             statement.executeUpdate();

//             // debug
//             System.out.println("name" + stuff.getName());
//             System.out.println("quantity" + stuff.getQuantity());
//             System.out.println("date" +stuff.getDate());
//             System.out.println("allocation" + stuff.getAllocation());
//             System.out.println("warranty" +stuff.getWarranty());

//             connection.close();

//             return "redirect:/create-items/create-item-stuff";
